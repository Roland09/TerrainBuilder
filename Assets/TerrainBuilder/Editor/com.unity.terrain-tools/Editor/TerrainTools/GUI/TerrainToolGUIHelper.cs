...
internal static class TerrainToolGUIHelper
{
   ...
   /* Rowlan: removed, not needed and caused compiler error because ResetBrush wasn't found; we'd have had to include a whole bunch of new classes because of that
