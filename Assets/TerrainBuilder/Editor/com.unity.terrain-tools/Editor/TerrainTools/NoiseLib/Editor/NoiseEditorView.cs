    ...
    internal class NoiseEditorView : BindableElement
    {
        ...
        public NoiseEditorView(NoiseSettings _noiseUpdateTarget_ = null, NoiseSettings _sourceAsset_ = null)
        {
            ...
            var stylesheet = EditorGUIUtility.isProSkin ?
                AssetDatabase.LoadAssetAtPath<StyleSheet>("Packages/com.rowlan.terrainbuilder/Editor/com.unity.terrain-tools/Editor/TerrainTools/NoiseLib/Styles/Noise_Dark.uss") :
                AssetDatabase.LoadAssetAtPath<StyleSheet>("Packages/com.rowlan.terrainbuilder/Editor/com.unity.terrain-tools/Editor/TerrainTools/NoiseLib/Styles/Noise_Light.uss");
